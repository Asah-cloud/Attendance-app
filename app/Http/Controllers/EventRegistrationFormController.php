...
class EventRegistrationFormController extends Controller
{
    ...
    public function updateBadgeSettings(Request $request, Event $event): RedirectResponse
    {
        ...
        $validated = $request->validate([
            ...
            'badge_fields.*' => ['array:x,y,w,h,size,align,visible,color,bold,text'],
            ...
            'badge_fields.*.color' => ['nullable', 'regex:/^#[0-9A-Fa-f]{6}$/'],
            'badge_fields.*.bold' => ['nullable', 'boolean'],
            'badge_fields.*.text' => ['nullable', 'string', 'max:200'],

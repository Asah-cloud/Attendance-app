...
<head>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .grid{display:grid;grid-template-columns:var(--badge-w);justify-content:center;gap:10mm;padding:10mm}.badge{--category:#0f766e;position:relative;width:var(--badge-w);height:var(--badge-h);overflow:hidden;border:1px solid #94a3b8;border-radius:5mm;display:flex;flex-direction:column;text-align:center;page-break-after:always;
            background-color:white;
            background-image:
                radial-gradient(circle,color-mix(in srgb,var(--category),transparent 92%) 1px,transparent 1.2px),
                radial-gradient(circle at 100% 100%,color-mix(in srgb,var(--category),transparent 82%),transparent 55%),
                radial-gradient(circle at -8% -12%,color-mix(in srgb,var(--category),transparent 88%),transparent 45%);
            background-size:6mm 6mm,100% 100%,100% 100%;background-repeat:repeat,no-repeat,no-repeat;}
        .badge:before,.badge:after{content:'';position:absolute;pointer-events:none}
        .badge:before{inset:0 0 auto;height:8mm;background:linear-gradient(105deg,var(--category) 0%,color-mix(in srgb,var(--category),white 25%) 55%,#5eead4 100%)}
        .badge:after{width:66mm;height:66mm;right:-34mm;bottom:-34mm;border-radius:50%;border:10mm solid color-mix(in srgb,var(--category),white 85%);box-shadow:0 0 0 1px color-mix(in srgb,var(--category),white 70%) inset}
        .category-design:before{height:13mm;background:var(--category)}
        .brand{z-index:1;flex-shrink:0;min-height:30mm;max-height:30mm;padding:9mm 9mm 3mm;display:flex;align-items:center;justify-content:center;gap:4mm;border-bottom:1px solid #e2e8f0;overflow:hidden}.brand-logo,.event-logo{width:16mm;height:16mm;object-fit:contain;flex-shrink:0}.brand-initial{width:15mm;height:15mm;border-radius:50%;display:grid;place-items:center;background:#ccfbf1;font-size:6mm;font-weight:900;flex-shrink:0}.company-name{max-width:85mm;font-size:5mm;font-weight:800;text-align:left;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}
        .event-block{z-index:1;flex-shrink:0;padding:4mm 9mm 3mm;display:flex;align-items:center;justify-content:center;gap:4mm;overflow:hidden}.event-title{margin:0;min-height:14mm;font-size:5.8mm;line-height:1.2;font-weight:900;color:var(--category);display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.event-meta{margin:2mm 0 0;color:var(--muted);font-size:3.2mm;line-height:1.35;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.attendee{z-index:1;flex-shrink:0;padding:4mm 9mm 0;min-height:0;overflow:hidden;display:flex;flex-direction:column}.attendee-label{margin:0 0 2mm;color:var(--muted);font-size:3mm;font-weight:800;letter-spacing:.18em;text-transform:uppercase}.name{margin:0;min-height:20mm;font-size:9mm;line-height:1.1;font-weight:900;overflow-wrap:anywhere;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}.details{margin-top:2.5mm;display:flex;flex-wrap:wrap;justify-content:center;gap:2mm}.pill{border-radius:999px;padding:1.2mm 4mm;background:color-mix(in srgb,var(--category),white 86%);color:var(--category);font-size:3mm;font-weight:800;max-width:75mm;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}
        .qr{z-index:1;flex-shrink:0;margin:auto auto 3mm;padding:2.5mm;border:1px solid #cbd5e1;border-radius:3mm;background:white;line-height:0}.qr svg{width:{{ $event->badge_size === 'A5' ? '48mm' : '34mm' }};height:{{ $event->badge_size === 'A5' ? '48mm' : '34mm' }}}.scan{z-index:1;flex-shrink:0;margin:0 0 5mm;color:var(--muted);font-size:2.8mm;font-weight:700;text-transform:uppercase}.empty{padding:30px;background:white;text-align:center}

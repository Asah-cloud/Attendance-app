...
>
    {{-- Background Overlay (Frosted Glass) --}}
    <div
        x-show="show"
    ...
    <div
        x-show="show"
        class="mb-6 bg-white rounded-[2rem] overflow-hidden shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] transform transition-all sm:w-full {{ $maxWidth }} sm:mx-auto border border-gray-100"
        x-transition:enter="ease-out duration-300"
    ...
    >
        ...
        <div class="h-1.5 w-full bg-gradient-to-r from-blue-600 to-purple-600"></div>

@php
    ...
    $pageLabel = match (true) {
        ...
        request()->routeIs('events.accommodation.*') => 'Accommodation',
        ...
        request()->routeIs('support-staff.report*') => 'Staff report',
    ...
    $eventLinks = $contextEvent ? array_values(array_filter([
        ...
        ['label' => 'Staff', 'route' => route('support-staff.checkin', $contextEvent), 'active' => request()->routeIs('support-staff.checkin*', 'support-staff.report*')],
        $user->can('update', $contextEvent) ? ['label' => 'Forms', 'route' => route('events.forms.index', $contextEvent), 'active' => request()->routeIs('events.forms.*', 'events.registration-form.*', 'events.confirmations.*')] : null,

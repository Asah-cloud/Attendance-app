<x-app-layout>
    ...
    <div class="mx-auto max-w-2xl">
        <div class="mb-6 flex flex-col justify-between gap-4 sm:flex-row sm:items-end">
            ...
            <a href="{{ route('admin.users.index') }}" class="rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-center text-xs font-extrabold text-slate-600 hover:border-blue-300 hover:text-blue-700">Back to team</a>
        </div>

...
<body>
    <h1>{{ $event->title }}</h1>
    <div class="meta">
        Attendance report &middot; {{ $event->attendanceSessionLabel($selectedDay) }} &middot; unique people, including checked-in numbered staff &middot; Generated {{ now()->format('M j, Y g:i A') }}
    </div>

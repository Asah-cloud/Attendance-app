        ...
        <section class="overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-sm">
            <details data-acc="attendees" open class="group">
                ...
                <div x-data="{ q: '', unassignedOnly: false, needsOnly: false }" class="p-4">
                    ...
                    <p class="mt-2 text-xs text-slate-400">Rooms set to <strong>reserved</strong> are skipped by "Assign rooms now" — pick them here to hand-place special guests, then tick <strong>Lock</strong>. "Closed" rooms can't be assigned at all. Untick <strong>Email now</strong> to hold off notifying an attendee — batch-assign everyone first, then use "Email rooms to attendees" above to send them all at once.</p>
